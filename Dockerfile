...
RUN tar -zxvf /usr/local/pinpoint-agent-1.7.3/pinpoint-agent-1.7.3.tar.gz -C /usr/local/pinpoint-agent-1.7.3
...
EXPOSE 8080
ENTRYPOINT ["java","-jar", \
"-javaagent:/usr/local/pinpoint-agent-1.7.3/pinpoint-bootstrap-1.7.3.jar", \
"-Dpinpoint.applicationName=TrendPick", \
"-Dpinpoint.config=/usr/local/pinpoint-agent-1.7.3/pinpoint.config", \
